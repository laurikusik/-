...
namespace pr1_z4
{
    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            Car[] cars = new Car[4];
            double distance = 400;
            Car Hyundai = new Car("Hyundai Solaris", 320, distance);
            cars[0] = Hyundai;
            Car Lada = new Car("Lada Vesta", 310, distance);
            cars[1] = Lada;
            Car Chery = new Car("Chery Omoda 5", 360, distance);
            cars[2] = Chery;
            Car Kia = new Car("Kia Sportage", 420, distance);
            cars[3] = Kia;
